  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        <img className='w-fu11 md:max-w-[450px]' src={assets.about_img} alt="" />
        <div className='flex flex-col justify-center gap-6 md:w-2/4 0 text-gray-600'>
          <p>Trever was born out of a passion for innovation and a desire to revolutionize the way
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className=' border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          ...
          <p className=' text-gray-600' >We meticulously select and vet each product to  ensure it meets our high standards of quality, safety, and performance.</p>

        </div>
        <div className=' border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p className=' text-gray-600' >With our user-friendly interface and hassle-free  returns, you can shop with confidence and enjoy a seamless experience.</p>

        </div>
        <div className=' border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Exceptiona1 Customer Service:</b>
          <p className=' text-gray-600' >Our team of dedicated professionals is here to assist you every step of the way, ensuring your satisfaction and loyalty.</p>
        </div>
      </div>
